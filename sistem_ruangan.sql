...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 15, 2019 at 02:37 PM
...
('OBS0001', 'REQ0002', 'A1-201', '2019-07-18', '10:00:00', '11:30:00', 'Approved'),
('OBS0002', 'REQ0003', 'A1-201', '2019-07-18', '11:30:00', '12:00:00', 'Approved'),
('OBS0003', 'REQ0004', 'A1-201', '2019-07-18', '08:00:00', '10:00:00', 'Approved');
...
INSERT INTO `tb_organisasi` (`nama_organisasi`, `username`, `password`, `email_organisasi`, `level`, `pic`, `fakultas`, `status`, `active`) VALUES
...
('BKAK', 'bkak.admin', '6ab16070058a20652dd44e67a496e2fe', '-', 'admin', 'Universitas', 'Universitas', 'Clear', 1),
...
('Kabid FEB', 'kabid.feb', '54547d78cfc78bf51f7512046f617084', '-', 'kabid', 'Fakultas', 'FEB', 'Clear', 1),
('Kabid FH', 'kabid.fh', '8a529c94a330c0780da7e8f47b27ae65', '-', 'kabid', 'Fakultas', 'FH', 'Clear', 1),
('Kabid FIABIKOM', 'kabid.fiabikom', '17197898059aaec25ace6a443fa140be', '-', 'kabid', 'Fakultas', 'FIABIKOM', 'Clear', 1),
('Kabid FK', 'kabid.fk', 'adf9e4fbdf57da5ace2c28f3e5a0d0d3', '-', 'kabid', 'Fakultas', 'FK', 'Clear', 1),
('Kabid FP', 'kabid.fp', '439db6be7c602b63b27cf9560161d45c', '-', 'kabid', 'Fakultas', 'FP', 'Clear', 1),
('Kabid FPB', 'kabid.fpb', '3959fcbaa3a3ec5afbfe56c1e6a5f5a9', '-', 'kabid', 'Fakultas', 'FPB', 'Clear', 1),
('Kabid FT', 'kabid.ft', 'da11fa189ad3d923be3add1cfe8a048f', '-', 'kabid', 'Fakultas', 'FT', 'Clear', 1),
('Kabid FTB', 'kabid.ftb', '7d07e75403f9cdc3e23c45898b5744f2', '-', 'kabid', 'Fakultas', 'FTB', 'Clear', 1),
...
INSERT INTO `tb_report` (`id_report`, `nama_organisasi`, `status`, `tgl_report`, `keterangan`) VALUES
('RPT0001', 'Workshop Industri FT', 'Block', '2019-07-15', 'Tidak Bertanggung jawab atau ruangan yang dipinjam'),
('RPT0002', 'Workshop Industri FT', 'Clear', '2019-07-15', 'Masalah sudah diselesaikan bersama dengan warek 3');
...
('REQ0001', 'Himpunan Mahasiswa Teknik Elektro', 'A1-201', 'Rapat Himpunan', '2019-07-15', '2019-07-18', '90 minutes', '10:00:00', '11:30:00', 'Himpunan Mahasiswa Teknik Elektro', 'Declined', 'Ruangan sudah dibooking oleh FPB, silahkan cari ruangan lainnya'),
('REQ0002', 'Himpunan Mahasiswa Pendidikan Bahasa Inggris FPB', 'A1-201', 'Rapat Himpunan', '2019-07-15', '2019-07-18', '90 minutes', '10:00:00', '11:30:00', 'Himpunan Mahasiswa Pendidikan Bahasa Inggris FPB', 'Approved', '-'),
('REQ0003', 'Aikido Club', 'A1-201', 'Rapat BPM FEB', '2019-07-15', '2019-07-18', '30 minutes', '11:30:00', '12:00:00', 'BKAK', 'Approved', 'Rapat urgent dan sudah dapat ijin dari warek 3'),
('REQ0004', 'Workshop Industri FT', 'A1-201', 'Rapat Workshop Industri', '2019-07-15', '2019-07-18', '120 minutes', '08:00:00', '10:00:00', 'BKAK', 'Approved', 'Rapat Mendadak dan sudah dapat ijin dari warek 3');
...
ALTER TABLE `tb_report`
  ADD CONSTRAINT `FK_NamaOrganisasi(2)` FOREIGN KEY (`nama_organisasi`) REFERENCES `tb_organisasi` (`nama_organisasi`) ON UPDATE CASCADE;
